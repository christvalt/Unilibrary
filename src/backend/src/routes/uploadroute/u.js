...
const { create_book } = require("../../controllers/bookcontrollers/booksController");
const { delete_book } = require("../../controllers/bookcontrollers/booksController");
const { update_book } = require("../../controllers/bookcontrollers/booksController");
